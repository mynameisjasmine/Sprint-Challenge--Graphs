...
#     # if prev_id is not None and curr_dir is not None and prev_dir is not None:
#     #     visited[player.current_room.id][prev_dir] = prev_id
#     #     visited[prev_id][curr_dir] = player.current_room.id
...
#                 #Add the current room id (and available exits) to the visited dictionary if it's not in there already
#                 if player.current_room.id not in visited:
#                     visited[player.current_room.id] = new_exits.copy()
...
#         print('room id:', player.current_room.id, visited)
